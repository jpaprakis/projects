...
--tests will contain all your JUnit test cases (.java files). Your lab on 24th June will be your first introduction on how to write JUnit tests. 

--You are welcome to dedicate the last sprint (see readMe inside the Sprint folder) to dedicate the last sprint for testing if your team so desires. Alternatively, you can have part of each sprint responsible for some portion of testing.  
