...
public class TestingDirectory {
	...
	List<Directory> test = Arrays.asList(C);

	
//	@Test
//	public void testMakeDirToRemoveList() {
//		List <FileSystem>dirList = Directory.makeDirToRemoveList((FileSystem)C);
//		for (FileSystem node : dirList) {
//			System.out.println(node.getName());
//		}
//		assertEquals(Directory.makeDirToRemoveList(C), Arrays.asList(C3));
//	}
//	
//	
	@Test 
		public void testfindNode() {
		List <FileSystem> testList = Arrays.asList((FileSystem)C);
		List <FileSystem> testList2 = Arrays.asList((FileSystem)A);
		assertEquals(Directory.findNode(testList),Arrays.asList(C11, C1_1File, C3));
		assertEquals(Directory.findNode(testList2), Arrays.asList(A, AFile)); 
